...
void
AudioPluginAudioProcessor::changeProgramName(int index,
...
void
AudioPluginAudioProcessor::processBlock(juce::AudioBuffer<float>& buffer,
...
void
AudioPluginAudioProcessor::setStateInformation(const void* data,
                                               int sizeInBytes)
{
