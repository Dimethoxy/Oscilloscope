...
//  *
//  * License:
//  * This code is licensed under the GPLv3 license. You are permitted to use
//  and
//  * modify this code under the terms of this license.
//  * You must adhere GPLv3 license for any project using this code or parts of
//  it.
...
//  * waveform based on the current oscillator parameters. The component
//  supports
